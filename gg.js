/* ============================================================
   ...
   - Tables used: users, appointments
   - Login: direct match on users.email + users.password,
            routes by users.user_type ('admin' | 'student')
   - Appointments: appointments table
            (id, user_email, date, time, type, message, created_at)

   HTML/CSS unchanged. All field IDs below are the Info:Sched ones.
   ID → DB column mapping lives inside each module.
   ============================================================ */

/* ---------- SUPABASE CONFIG (BACOR project) ---------- */
    ...
    function tryInit() {
        if (window.supabase && typeof window.supabase.createClient === 'function') {
            try {
                ...
                console.log('[gg.js] BACOR Supabase client ready');
                return true;
            } catch (e) {
                console.error('[gg.js] Supabase init failed:', e);
                return false;
            }
        }
        return false;
...
/* ============================================================
   0. GLOBAL UI — TOAST + CONFIRM (unchanged)
   ============================================================ */
const GG = (function () {
    'use strict';
...
/* ============================================================
   1. LANDING MODULE (unchanged — placeholder data)
   ============================================================ */
(function landingModule() {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const PLACEHOLDER_EVENTS = [
            { id: 'e1', title: 'Sample Event 1 — Replace me', date: isoOffset(3),  category: 'community',    type: 'event', status: 'upcoming',  location: 'Barangay Hall',  description: 'Temporary placeholder event.' },
            { id: 'e2', title: 'Sample Event 2 — Replace me', date: isoOffset(10), category: 'cultural',     type: 'event', status: 'upcoming',  location: 'Plaza',          description: 'Temporary placeholder event.' },
            { id: 'e3', title: 'Sample Event 3 — Replace me', date: isoOffset(0),  category: 'healthcare',   type: 'event', status: 'today',     location: 'Health Center',  description: 'Temporary placeholder event.' },
            { id: 'e4', title: 'Sample Event 4 — Replace me', date: isoOffset(-5), category: 'infrastructure', type: 'event', status: 'completed', location: 'Main Road',      description: 'Temporary placeholder event.' }
        ];
        ...
        const PLACEHOLDER_ANNOUNCEMENTS = [
            'TEMPORARY: This announcement is a placeholder — replace with real data.',
        ...
        function openFullInfoModal(item) {
            ...
            document.getElementById('fullInfoContent').innerHTML = `
                ...
                <p style="margin-top:1rem;color:#a00;font-weight:600;">TEMPORARY placeholder content — replace with real data.</p>`;
            modal.classList.add('active');
        }
...
/* ============================================================
   ...
   Signup: insert into users (first_name, last_name, email,
           password, dob, user_type='student')
   HTML IDs are Info:Sched ones; mapping happens here.
   ============================================================ */
(function authModule() {
    'use strict';
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        async function signIn() {
            ...
            try {
                ...
                // Persist user info the way BACOR does
        ...
        function validatePhone() {
            ...
            if (!re.test(v)) { showFieldError(input, err, 'Please enter a valid Philippine mobile number (09XXXXXXXXX)'); return false; }
            clearFieldError(input, err); return true;
        }
        ...
        /* ---------- FORGOT (demo — BACOR has no password reset endpoint) ---------- */
...
/* ============================================================
   ...
   Appointments: insert into appointments table
     columns: id, user_email, date, time, type, message, created_at
   HTML IDs stay as Info:Sched ones — mapping happens here.
   ============================================================ */
(function residentModule() {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        /* Gate: must be a logged-in student */
        ...
        /* ---------- Profile modal (still local-only) ---------- */
        ...
        /* ---------- Application type / (ID option kept but inert) ---------- */
        ...
        /* ---------- Appointment confirmation (simplified: no ID/OTP) ---------- */
        ...
        /* ---------- Dashboard loads (BACOR appointments) ---------- */
        ...
        window.resendCode            = function () { GG.toast('Email verification is not required for this project.', 'info', 'Skipped'); };
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        async function updateStats() {
            try {
                ...
                // Admin.html uses these labels: Total Events, Active Announcements, Active Appointments, Active Users
                set('totalEvents', students);          // repurpose: Total Students
                set('totalAnnouncements', admins);     // repurpose: Total Admins
        ...
        async function updateRecentActivity() {
            ...
            try {
                ...
                console.error('updateRecentActivity:', e);
            }
        }

        /* ---------- Content tab (repurposed to show users) ---------- */
        ...
        /* ---------- Announcements tab → repurposed to users too ---------- */
        async function loadAnnouncements() {
